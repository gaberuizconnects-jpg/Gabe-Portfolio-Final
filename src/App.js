        ...
        <div className="flex-1 p-8 overflow-y-auto relative bg-[#0a0a0a]">
          <div className="relative z-10 max-w-lg">
            ...
            <a
              ...
              className="group inline-flex items-center gap-3 px-6 py-3 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 transition-all hover:scale-105"
            >
...
const ContentRenderer = ({ section }) => {
  ...
  const handleContactSubmit = (e) => {
    ...
    const subject = encodeURIComponent(`Portfolio Contact: ${contactForm.name}`);
    ...
    case "audio":
      return (
        <div className="grid md:grid-cols-2 gap-8 text-left">
          <div>
            <h4 className="text-xl font-bold text-white mb-6">Latest Episodes</h4>
          ...
          <form className="space-y-4" onSubmit={handleContactSubmit}>
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                <label className="text-xs font-mono text-slate-500">IDENTIFIER</label>
                <input
                  type="text"
                  placeholder="Name"
              ...
              <div className="space-y-1">
                <label className="text-xs font-mono text-slate-500">RETURN ADDRESS</label>
                <input
                  type="email"
                  placeholder="Email"
            ...
            <div className="space-y-1">
              <label className="text-xs font-mono text-slate-500">TRANSMISSION</label>
              <textarea
                rows={6}
